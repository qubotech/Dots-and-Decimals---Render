    ...
    <>
      ...
      <div className="py-8 md:py-16 lg:py-20 bg-[#101010] text-white">
        ...
        >
          ...
          <h2 data-aos="fade-up" className="heading-2 max-w-[50rem] px-4">
            We Offer a Wide Range of IT Services
          </h2>
          <p data-aos="fade-up" className="desc max-w-[50rem] px-4">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 mt-3 w-full">
